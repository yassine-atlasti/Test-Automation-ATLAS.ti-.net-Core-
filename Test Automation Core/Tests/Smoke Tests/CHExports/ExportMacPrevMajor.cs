...
namespace Test_Automation_Core.Tests.Smoke_Tests.CHExports
{
    public class ExportMacPrevMajor
    {
        ...
        public void exportAtlProj()
        {
            ...
            bool atlProjExportState = smokeTestClass.GetAppActions().ExportProject(SmokeTestVariables.smokeTestFolderPath, "Atlproj", CHProjects.MacPreviousAtlProj.Replace(" ", ""));
        ...
        public void exportQDPX()
        {
            ...
            bool qdpxExportState = smokeTestClass.GetAppActions().ExportProject(SmokeTestVariables.smokeTestFolderPath, "QDPX", CHProjects.MacPreviousQDPX.Replace(" ", ""));
