...
namespace Test_Automation_Core.Tests.Smoke_Tests.CHExports
{
    public class ExportWinPrevMajor
    {
        ...
        public void exportAtlProj()
        {
            ...
            bool atlProjExportState = smokeTestClass.GetAppActions().ExportProject(SmokeTestVariables.smokeTestFolderPath, "Atlproj", Path.GetFileName(CHProjects.WinPreviousAtlProjPath));
        ...
        public void exportQDPX()
        {
            ...
            bool qdpxExportState = smokeTestClass.GetAppActions().ExportProject(SmokeTestVariables.smokeTestFolderPath, "QDPX", Path.GetFileName(CHProjects.WinPreviousQDPXPath));
